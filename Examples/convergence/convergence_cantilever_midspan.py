...
RESULTS_ROOT = str(project_root / "Examples" / 'Results' / 'FEM' / 'cantilever_midspan')
from Examples.Structure_FEM.cantilever_midspan import BASE_CONFIG, apply_conditions
