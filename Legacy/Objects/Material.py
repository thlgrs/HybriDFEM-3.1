...
class KSP_concrete(Material):
    ...
    def update(self, dL): 
        ...
        # Compression
        if self.strain['e'] <= 0:  # and self.strain['e'] <= self.strain['e_max']: #Loading

            # self.strain['e_max'] = self.strain['e']
            ...
            if self.strain['e'] < self.strain['ecu']: 
                ...
                r = self.strain['e'] / self.strain['ec']
                self.stress['s'] = self.stress['fc'] * (2 * r - r ** 2)
                self.stiff['E'] = 2 * self.stress['fc'] * (1 - r) / self.strain['ec']

            # self.strain['e_p'] = self.strain['e'] - self.stress['s'] / self.stiff0['E']

        # elif self.strain['e'] <= 0:
        #     self.stress['s'] = - self.stiff0['E'] * (self.strain['e_p'] - self.strain['e'])
        #     self.stiff['E'] = self.stiff0['E']
