...
filename = 'Response_NF13_1.5_NWK_g=0.5_b=0.25.h5'
...
for i in range(frames_needed):
    ...
    St.plot_structure(scale=1, plot_cf=False, plot_forces=False, plot_supp=False, show=False, save=saveto, lims=lims)
...
video_filename = 'Video_Frame' + '.mp4'
